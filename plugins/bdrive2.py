...
async def process_and_upload_video(video_obj, token, id2, c, progress_msg, user_id, quality_key, task_id):
    ...
    try:
        ...
        # Monitor for cancellation during FFmpeg execution
...
async def sync_data(tokeni, id2, url, c, status_msg, user_id, quality, task_id):
    try:
        ...
        for alpha in alpha_results:
            ...
            for folder in series_folders:
                ...
                name_val, dj_val = parts[0], parts[1] if len(parts) > 1 else 'Unknown'
                text_val = f"{name_val.lower()}.dd#.859704527"
