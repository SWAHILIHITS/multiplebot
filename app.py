...
def captive_login_page():
    ...
    # Check if this MAC already has an unexpired active session
    ...
    if existing_session and existing_session.get("expire_date"):
        ...
        if exp > now:
            # Re-generate temporary token and bypass portal form
...
def process_login():
    ...
    # 4. Meta Refresh + JavaScript redirect page
    return f"""
    <!DOCTYPE html>
    <html lang="sw">
    <head>
...
def wifidog_auth_check():
    ...
    try:
        ...
        # Fallback to prevent returning HTML 500 error pages to router
        return Response("Auth: 0\n", mimetype='text/plain')
